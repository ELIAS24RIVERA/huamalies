...
// Estilos del Modal con Material-UI
...
// Componente Modal para errores de fecha
const DateErrorModal = ({ handleClose, open }) => {
...
const HomePage = () => {
  ...
  // Simulación de validación de fechas (deberías reemplazar esto con tu lógica real)
  useEffect(() => {
    // Ejemplo: validar después de 3 segundos (simulando carga)
    const timer = setTimeout(() => {
      setModalOpen(true); // Cambiar a false en producción y activar con tu lógica real
    }, 3000);
  ...
  return (
    <MainContainer>
      {/* Modal para errores de fecha */}
      <DateErrorModal open={modalOpen} handleClose={handleCloseModal} />
